...
- [API 参考](docs/API参考.md)：逐个公开 API 的原型、单位、工作区、复位与错误处理。
- [API 调用教程](docs/API调用教程.md)：从 ADC/DMA 到显示、DAC 的完整可编译示例。

推荐阅读顺序：先看[快速开始](docs/快速开始.md)，再查 API 参考，最后复制 API 调用教程中的完整程序。
